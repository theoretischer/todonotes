 ...
 *
 * - Android: echte AlarmManager + Notification (M8), [NotificationStyle]
 *   steuert ob Vollbild / nur Benachrichtigung / stumm
...
interface AlarmScheduler {
    /** Alarm für [dueAt] (millis) planen. [notificationStyle] = NotificationStyle.value. */
    fun scheduleAlarm(
        dueAt: Long,
        todoId: String,
        title: String,
        notes: String?,
        notificationStyle: Int = 0
    )
