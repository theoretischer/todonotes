# TodoNotes – Progress (ARCHIV)

> **Historisches Dokument** — Stand vor Abschluss der CMP-Migration.
> Enthält die Original-Block-Planung (A–H) der nativen Android-App inkl.
> F7–F12-Notizen (Bilder/Stift/Sync/Polish), davon sind manche noch offen →
> aktuelle Liste in `../PROGRESS.md`.
> Archiviert bei CMP-Abschluss (M1–M9 + M8 + Produktions-Deploy fertig).
